...
/// Preserved remote (FastAPI) milestone repository.
///
/// **Deprecated as runtime:** The active runtime uses [LocalMilestoneRepository].
/// This adapter remains for future remote access or synchronization.
class ApiMilestoneRepository implements MilestoneRepositoryInterface {
  ApiMilestoneRepository(this._dio);
  final Dio _dio;
...
final apiMilestoneRepositoryProvider = Provider<ApiMilestoneRepository>((ref) {
  return ApiMilestoneRepository(ref.watch(dioProvider));
});
