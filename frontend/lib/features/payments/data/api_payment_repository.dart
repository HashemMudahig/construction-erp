...
/// Preserved remote (FastAPI) payment repository.
///
/// **Deprecated as runtime:** The active runtime uses [LocalPaymentRepository].
class ApiPaymentRepository implements PaymentRepositoryInterface {
...
final apiPaymentRepositoryProvider = Provider<ApiPaymentRepository>((ref) {
  return ApiPaymentRepository(ref.watch(dioProvider));
});
