...
/// Preserved remote (FastAPI) expense repository.
///
/// **Deprecated as runtime:** The active runtime uses [LocalExpenseRepository].
class ApiExpenseRepository implements ExpenseRepositoryInterface {
  ApiExpenseRepository(this._dio);
  final Dio _dio;
...
final apiExpenseRepositoryProvider = Provider<ApiExpenseRepository>((ref) {
  return ApiExpenseRepository(ref.watch(dioProvider));
});
